            ...
            export class ConnectionManager {
                ...
                enterConnectionMode() {
                    ...
                    this.connectables.forEach(connectable => {
                        const meshToHighlight = connectable.highlightMesh ?? connectable.mesh;
                        if (!meshToHighlight) {
                            return;
                        }
                        if (connectable.type == "source") {
                            this.highlightLayer.addMesh(meshToHighlight, BABYLON.Color3.Red());
                        }
                        else {
                            this.highlightLayer.addMesh(meshToHighlight, BABYLON.Color3.Green());
                        }
                    });
